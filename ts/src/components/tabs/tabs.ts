...
export class TabsBehavior extends Behavior {
     ...
     * @param tablist
     */
    shouldSelectOnFocus(tablist: Element | null) {
     ...
     * @param exceptTab
     */
    deselectAllOtherAnchorsInTablist(tablist: Element | null, exceptTab: HTMLButtonElement | HTMLAnchorElement ) {
      if (tablist) {
